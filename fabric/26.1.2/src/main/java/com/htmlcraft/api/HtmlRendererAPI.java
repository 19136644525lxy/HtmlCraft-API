...
/**
 * HtmlCraft API 对外统一入口（Fabric 26.2 版）。
 * 提供便捷的 HTML 渲染 Screen 创建方法。
 * <p>26.2 变化：Text 类重命名为 Component（包路径 net.minecraft.network.chat）。
 */
public class HtmlRendererAPI {

    /** 创建一个 HTML Screen 构建器。 */
    public static Builder createScreen(Component title) {
     ...
     * 最终 {@link #build()} 生成可被 {@code client.gui.setScreen(screen)} 打开的 {@link HtmlScreen}。
     */
