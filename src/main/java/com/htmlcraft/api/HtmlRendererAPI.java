...
public class HtmlRendererAPI {
     ...
     * 最终 {@link #build()} 生成可被 {@code Minecraft.getInstance().setScreen()} 打开的 {@link HtmlScreen}。
     */
    public static class Builder {
        ...
        /**
         * 构建 HtmlScreen 实例。
         * <p>返回的 Screen 应通过 {@code Minecraft.getInstance().setScreen(screen)} 打开。
